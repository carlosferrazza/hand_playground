...
def get_assets() -> Dict[str, bytes]:
  ...
  mjx_env.update_assets(assets, consts.ROOT_PATH / "assets", "*.xml")
  mjx_env.update_assets(assets, consts.ROOT_PATH / "models", "*.mjcf")
  mjx_env.update_assets(
      assets, consts.ROOT_PATH / "assets" / "reorientation_cube_textures"
  )
  mjx_env.update_assets(assets, consts.ROOT_PATH / "assets" / "meshes")
  mjx_env.update_assets(assets, consts.ROOT_PATH / "assets" / "left" / "visual")
  return assets
