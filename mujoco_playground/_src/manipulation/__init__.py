...
from mujoco_playground._src.manipulation.orca_hand import rotate_z as orca_rotate_z
...
_envs = {
    ...
    "OrcaCubeRotateZAxis": orca_rotate_z.CubeRotateZAxis,
}
